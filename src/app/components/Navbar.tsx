  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        >
          <span
            className={`block w-6 h-0.5 transition-transform ${menuOpen ? "rotate-45 translate-y-1.5" : ""}`}
      ...
      {menuOpen && (
        <nav
          className="md:hidden flex flex-col items-center gap-6 py-6 border-t"
          style={{ borderColor: "#c9a87a", backgroundColor: "#f5ead8" }}
